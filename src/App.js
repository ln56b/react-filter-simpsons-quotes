...
class App extends Component {
  constructor(props) {
    ...
    this.handleShowSimpsonOnly = this.handleShowSimpsonOnly.bind(this);
  }
  handleShowSimpsonOnly() {
    this.setState({ simpsonOnly: !this.state.simpsonOnly });
  }

  render() {
    return (
      <div>
        <button onClick={this.handleShowSimpsonOnly}>
          Show only Simpson quotes: {this.state.simpsonOnly ? 'ON' : 'OFF'}
        </button>
